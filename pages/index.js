...
export default function Home() {
  return (
    <div >
      <Head>
        <title>shoppingcart.com - Enjoy your shop</title>
        <meta name="description" content="shoppingcart.com - Enjoy your shop" />
      ...
      <section class="text-gray-600 body-font">
        <div class="container px-5 py-24 mx-auto">
          <div class="flex flex-wrap w-full mb-20 flex-col items-center text-center">
            <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Enjoy The Shopping With shoppingcart.com</h1>
            <p class="lg:w-1/2 w-full leading-relaxed text-gray-500">Wear Whatever You Want? what do you want? You Want Shop? So Buy what You Want.</p>
          </div>
